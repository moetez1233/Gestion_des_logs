...
public class PDFTableStripper extends PDFTextStripper
{
    ...
    public static void pdfData(MultipartFile file) throws IOException
    {
        ...
        try (PDDocument document = PDDocument.load(file.getInputStream()))
        {
            ...
            stripper.setRegion(new Rectangle((int) Math.round(1.0*res), (int) Math.round(1*res), (int) Math.round(8*res), (int) Math.round(9.0*res)));
